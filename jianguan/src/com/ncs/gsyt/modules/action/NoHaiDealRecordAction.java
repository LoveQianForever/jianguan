...
@Namespace("/admin")
@Controller
public class NoHaiDealRecordAction extends BaseAction implements ModelDriven<NoHaiDealRecord>{
	...
	@Action(value = "/nohaidealrecord", results = {
			@Result(name = SUCCESS, location = "/admin/pig/nohaidealrecordlist.jsp"),
			@Result(name = "add", location = "/admin/pig/addnohaidealrecord.jsp"),
			@Result(name = "addBatch", location = "/admin/pig/addBatchnohaidealrecord.jsp"),//添加批次概念
			@Result(name = "modify", location = "/admin/pig/modifynohaidealrecord.jsp"),
			@Result(name = "modifyBatch", location = "/admin/pig/modifyBatchnohaidealrecord.jsp"),//添加批次概念
			@Result(name = "stopModify", location = "/admin/pig/modifynohaidealrecord1.jsp"),
			@Result(name = "stopBatchModify", location = "/admin/pig/modifyBatchnohaidealrecord1.jsp")//添加批次概念
	})
	...
	public String saveAdd()throws Exception
	{
		...
		if(count1!=0)
		{
			...
			noHaiDealRecord.setPiCi(batchID);
		}
