...
@Namespace("/admin")
@Controller
public class DieRecordAction1 extends BaseAction implements ModelDriven<DieRecord>{
	...
	@Action(value = "/dierecord1", results = {
			@Result(name = SUCCESS, location = "/admin/poultry/dierecordlist1.jsp"),
	...
	public String execute() {
		...
		dierecord = new DieRecord ();
		dierecord.setIdss(Long.parseLong(enterpriseID));
		return SUCCESS;
	}
