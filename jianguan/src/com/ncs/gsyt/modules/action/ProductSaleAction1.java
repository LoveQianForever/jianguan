...
@Namespace("/admin")
@Controller
public class ProductSaleAction1 extends BaseAction implements ModelDriven<ProductSale>{
	...
	@Action(value = "/productsale1", results = {
			@Result(name = SUCCESS, location = "/admin/zhongzhi/productsalelist1.jsp"),
	...
	public String execute() {
		...
		productsale.setIdss(Long.parseLong(enterpriseID));
		return SUCCESS;
	}
