    ...
    <tbody>
       ...
       <tr>
           ...
           <select id="batchID" name="batchID" class="input"  onfocus="this.className='inputClick'" class="inputText" style="width:520px;">
		        			 <option value="${intourupinrecord.piCi}">第${intourupinrecord.piCi}批</option>
        ...
        <tr >
            <th>产品名称：</th>
            <td>
            <input type="hidden" name="inrecordID" id="inrecordID" value="${intourupinrecord.inrecordID}">
           <select id="name" name="name">
		        			<option	value="${intourupinrecord.touRuPin.tourupinID}">${intourupinrecord.touRuPin.name}</option>
       ...
       <tr id="addseed">
        ...
        <tr>
            <th>数量：</th>
            <td>
            <input type="text" name="count" value="${intourupinrecord.count}" id="count" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
            
        </tr>
        <tr>
            <th>供货商：</th>
            <td>
            <input type="text" name="supplyName"  value="${intourupinrecord.supplyName}" id="supplyName" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
         ...
         <tr>
            <th>联系电话：</th>
            <td>
            <input type="text" name="phoneNumber"  value="${intourupinrecord.phoneNumber}" id="phoneNumber" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
            
        </tr>
       <tr>
            <th>进货时间：</th>
            <td>
            <input type="text" name="input_time"  value="${intourupinrecord.input_time}" id="input_time" class="input Wdate" style="width: 520px" 
