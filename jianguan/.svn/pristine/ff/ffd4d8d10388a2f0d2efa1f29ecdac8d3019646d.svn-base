...
@Namespace("/admin")
@Controller
public class PigMedicineUseRecordAction extends BaseAction implements ModelDriven<PigMedicineUseRecord>{
	...
	@Resource
	private BatchService batchService;//投入品对象
	...
	@Action(value = "/pigmedicineuserecord", results = {
			@Result(name = SUCCESS, location = "/admin/pig/pigmedicineuserecordlist.jsp"),
			@Result(name = "add", location = "/admin/pig/addpigmedicineuserecord.jsp"),
			@Result(name = "addBatch", location = "/admin/pig/addBatchpigmedicineuserecord.jsp"),//添加批次概念
			@Result(name = "modify", location = "/admin/pig/modifypigmedicineuserecord.jsp"),
			@Result(name = "modifyBatch", location = "/admin/pig/modifyBatchpigmedicineuserecord.jsp"),//添加批次概念
			@Result(name = "stopModify", location = "/admin/pig/modifypigmedicineuserecord1.jsp"),
			@Result(name = "stopBatchModify", location = "/admin/pig/modifyBatchpigmedicineuserecord1.jsp")//添加批次概念
	})
	...
	public String saveAdd()throws Exception
	{
		...
		PigMedicineUseRecord pigMedicineUseRecord=new PigMedicineUseRecord();//
			...
			if(count1!=0)
			{
				...
				pigMedicineUseRecord.setPiCi(batchID);
			}
