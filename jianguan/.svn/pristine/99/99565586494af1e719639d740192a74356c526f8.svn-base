...
import com.ncs.gsyt.core.base.search.hibernate.HibernateMetadataUtil;
import com.ncs.gsyt.core.base.search.hibernate.HibernateSearchProcessor;
...
public class HibernateBaseDAO {
	...
	protected boolean _deleteById1(Class<?> type, Serializable id) {
		if (id != null) {
			type = metadataUtil.getUnproxiedClass(type); //Get the real entity class
			Object entity = getSession().get(type, id);
			if (entity != null) {
