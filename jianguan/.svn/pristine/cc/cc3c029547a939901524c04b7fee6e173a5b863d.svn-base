...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/medicineuserecord!saveAddMedicineR.do" >
    ...
    <tbody>
       <colgroup>
    	...
    	<tr>
            <th>使用人：</th>
            <td>
            <input type="text" name="use_name" id="use_name"  onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />  
       		</td>
        </tr>
        <tr>
            <th>使用时间：</th>
