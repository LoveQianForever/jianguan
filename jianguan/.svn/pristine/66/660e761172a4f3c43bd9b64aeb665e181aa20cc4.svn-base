...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/poultryMenterprise!getList_pass.do',
		dataType: 'json',
		colModel: [
...
function inputPoulty(id){
	//引种记录

	window.location.href = "${ctx}/admin/inputpoulty1.do?enterpriseID="+id+"&datenow="+new Date()
}

function inFoodMedicineRecord(id){
	//销售记录
	window.location.href = "${ctx}/admin/infoodmedicinerecord1.do?enterpriseID="+id+"&datenow="+new Date();
	
}

function foodUseRecord(id){
	//销售记录
	window.location.href = "${ctx}/admin/fooduserecord1.do?enterpriseID="+id+"&datenow="+new Date();
}
function medicineUseRecord(id){
	//销售记录
	window.location.href = "${ctx}/admin/medicineuserecord1.do?enterpriseID="+id+"&datenow="+new Date();
}
function immunityRecord(id){
	//销售记录
	
	window.location.href = "${ctx}/admin/immunityrecord1.do?enterpriseID="+id+"&datenow="+new Date();
}
function disinfectionRecord(id){
	//销售记录
	window.location.href = "${ctx}/admin/disinfectionrecord1.do?enterpriseID="+id+"&datenow="+new Date();
}
function dieRecord(id){
	//销售记录
	window.location.href = "${ctx}/admin/dierecord1.do?enterpriseID="+id+"&datenow="+new Date();
}
function saleRecord(id){
	//销售记录
	window.location.href = "${ctx}/admin/salerecord1.do?enterpriseID="+id+"&datenow="+new Date();
}
	</script>
	</body>
