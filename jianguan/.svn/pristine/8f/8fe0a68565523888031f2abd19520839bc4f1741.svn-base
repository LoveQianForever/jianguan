 ...
 */
package com.ncs.gsyt.core.base.dao.hibernate;
...
import com.ncs.gsyt.core.base.dao.DAOUtil;
import com.ncs.gsyt.core.base.search.ExampleOptions;
import com.ncs.gsyt.core.base.search.Filter;
import com.ncs.gsyt.core.base.search.ISearch;
import com.ncs.gsyt.core.base.search.Search;
import com.ncs.gsyt.core.base.search.SearchResult;

/**
 * Implementation of <code>GenericDAO</code> using Hibernate. The
...
public class GenericDAOImpl<T, ID extends Serializable> extends
	...
	public boolean removeById1(Serializable id) {
		return _deleteById1(persistentClass, id);
	}
	...
	public List<T> serachByHql(String hql) {
		Query query = this.getSession().createQuery(hql);
