...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/tourupin!saveAddSeed.do" >
    ...
    <tbody>
       <colgroup>
        ...
        <tr>
            <th>生产厂家：</th>
            <td>
            <input type="text" name="factory" id="factory" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
           
        </tr>
        <tr>
            <th>生产日期：</th>
           <td>
            <input type="text" name="proDate" id="proDate" class="input Wdate" style="width: 520px" 
            	onFocus="WdatePicker({proDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})"/>
