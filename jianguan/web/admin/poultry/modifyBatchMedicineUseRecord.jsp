       ...
       <colgroup>
    	...
    	<tr>
           ...
           <select id="batchID" name="batchID" class="input"  onfocus="this.className='inputClick'" class="inputText" style="width:520px;">
		        			 <option value="${medicineuserecord.piCi}">第${medicineuserecord.piCi}批</option>
    	...
    	<tr>
            <th>使用人：</th>
            <td>
            <input type="hidden" name="useMedicineID" value="${medicineuserecord.useMedicineID}" />
            <input type="text" name="use_name" id="use_name" value="${medicineuserecord.use_name}" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />  
       		</td>
        </tr>
        <tr>
            <th>使用时间：</th>
            <td>
            <input type="text" name="use_time" value='<fmt:formatDate value="${medicineuserecord.use_time}"/>' id="use_time" class="input Wdate" style="width: 520px" 
        ...
        <tr>
            <th>使用数量：</th>
            <td>
            <input type="text" name="use_count" id="use_count" value="${medicineuserecord.use_count}" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />  
       		</td>
        </tr>
        ...
        <tr>
           ...
           <select id="mf_name" name="mf_name">
		        			<option	value="${medicineuserecord.inFoodMedicine.inmedicienfoodID}">${medicineuserecord.inFoodMedicine.mf_name}</option>
