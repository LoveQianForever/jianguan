...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/salerecord!getList_pass.do',
		dataType: 'json',
		colModel: [
			{display: '序号',name: 'id', width: 50, align: 'center',iskey:true},
			{display: '时间',name: 'sale_time', width: 150, align: 'center'},
			{display: '品种',name: 'poultryName', width: 80, align: 'center'},
			{display: '数量',name: 'count', width: 70, align: 'center'},
			{display: '销售地',name: 'salePlace', width: 100, align: 'center'},
			{display: '购买人',name: 'buyName', width: 100, align: 'center'},
			{display: '电话',name: 'buyTelephone', width: 100, align: 'center'},
			{display: '是否检疫',name: 'checkout', width: 50, align: 'center'},
			{display: '检疫员',name: 'checkName', width: 100, align: 'center'},
			{display: '检疫证号',name: 'checkCode', width: 100, align: 'center'},
	...
	function toolbarItem_onclick(cmd, grid) {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/salerecord!loadocc.do?ouc="+ouc;
			} else {
