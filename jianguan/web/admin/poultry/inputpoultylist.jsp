...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/inputpoulty!getList_pass.do',
		dataType: 'json',
		colModel: [
			{display: '序号',name: 'id', width: 50, align: 'center',iskey:true},
			{display: '时间',name: 'input_time', width: 120, align: 'center'},
			{display: '品种名称',name: 'poultryName', width: 80, align: 'center'},
			{display: '数量',name: 'count', width: 70, align: 'center'},
			{display: '生产厂家',name: 'proFactory', width: 150, align: 'center'},
			{display: '地址',name: 'proplace', width: 150, align: 'center'},
			{display: '联系电话',name: 'phoneNumber', width: 150, align: 'center'},
			{display: '品种证号',name: 'kindCode', width: 100, align: 'center'},
	...
	//品牌置前，将品牌商品添加到  商品前置列表里；所属归类为“具体品牌”
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/inputpoulty!loadocc.do?ouc="+ouc;
			} else {
