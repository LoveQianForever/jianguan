...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/fooduserecord!getList_pass.do',
		dataType: 'json',
		colModel: [
			...
			{display: '使用数量',name: 'use_count', width: 80, align: 'center'},
	...
	function toolbarItem_onclick(cmd, grid) {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/fooduserecord!loadocc.do?ouc="+ouc;
			} else {
