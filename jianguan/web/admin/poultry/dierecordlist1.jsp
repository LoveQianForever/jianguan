...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/dierecord1!getList_pass.do?enterpriseID=${dierecord.idss}',
		dataType: 'json',
		colModel: [
			{display: '序号',name: 'id', width: 50, align: 'center',iskey:true},
			{display: '时间',name: 'record_time', width: 120, align: 'center'},
			{display: '品种',name: 'poultryName', width: 80, align: 'center'},
			{display: '数量',name: 'count', width: 70, align: 'center'},
			{display: '病死原因',name: 'dieReason', width: 120, align: 'center'},
			{display: '处理方法',name: 'dealMethod', width: 120, align: 'center'},
	...
	function toolbarItem_onclick(cmd, grid) {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/dierecord1!loadocc.do?ouc="+ouc;
			} else {
