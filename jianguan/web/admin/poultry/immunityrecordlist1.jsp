...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/immunityrecord1!getList_pass.do?enterpriseID=${immunityrecord.idss}',
		dataType: 'json',
		colModel: [
			{display: '序号',name: 'id', width: 50, align: 'center',iskey:true},
			{display: '免疫时间',name: 'immunity_time', width: 120, align: 'center'},
			{display: '免疫病种',name: 'immunity_ais', width: 100, align: 'center'},
			{display: '数量',name: 'count', width: 70, align: 'center'},
			{display: '免疫方法',name: 'immunity_f', width: 120, align: 'center'},
			{display: '生产厂家',name: 'proFactory', width: 120, align: 'center'},
			{display: '疫苗批号',name: 'immunity_Code', width: 60, align: 'center'},
			{display: '未免疫数',name: 'immunity_count', width: 60, align: 'center'},
			{display: '未免疫原因',name: 'imm_because', width: 150, align: 'center'},
	...
	function toolbarItem_onclick(cmd, grid) {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/immunityrecord1!loadocc.do?ouc="+ouc;
			} else {
