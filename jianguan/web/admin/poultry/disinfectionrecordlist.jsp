...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/disinfectionrecord!getList_pass.do',
		dataType: 'json',
		colModel: [
			{display: '序号',name: 'id', width: 50, align: 'center',iskey:true},
			{display: '消毒时间',name: 'createtime', width: 120, align: 'center'},
			{display: '消毒范围',name: 'scope', width: 120, align: 'center'},
			{display: '消毒方法',name: 'metho', width: 120, align: 'center'},
			{display: '消毒药名称',name: 'proDisinf', width: 100, align: 'center'},
			...
			{display: '消毒员',name: 'disinf_name', width: 70, align: 'center'},
			{display: '所属企业',name: 'enterpriseName', width: 100, align: 'center'}],//其他字段内容按需要添加
		buttons: [
	...
	function toolbarItem_onclick(cmd, grid) {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/disinfectionrecord!loadocc.do?ouc="+ouc;
			} else {
