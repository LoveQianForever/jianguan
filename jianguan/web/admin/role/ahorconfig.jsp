...
$(function(){
	$.ajax({
		...
		type: 'POST',
		dataType : "json",
		url: "${ctx}/admin/roleNamage!configAhor_pass.do?role.roleid=${role.roleid}",//请求的action路径
...
$.ajax({
		...
		url: "${ctx}/admin/roleNamage!configAhorsubmit.do",//请求的action路径
		error: function () {//请求失败处理函数
			alert('请求失败');
		},
		success:function(data){ //请求成功后处理函数。 
...
<div class="guide">当前位置：角色管理-权限配置</div>
<br/>
<form action="${ctx}/admin/roleNamage!configAhorsubmit.do" id="form1" method="post">
