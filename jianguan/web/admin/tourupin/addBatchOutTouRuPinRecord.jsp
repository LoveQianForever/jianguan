...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/outtourupinrecord!saveSeedIn.do" >
    ...
    <tbody>
       <colgroup>
        ...
        <tr>
            <th>姓名：</th>
            <td>
            <input type="text" name="names" id="names" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
            
        </tr>
        <tr>
            <th>地址、电话：</th>
            <td>
            <input type="text" name="addressPhone" id="addressPhone" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
