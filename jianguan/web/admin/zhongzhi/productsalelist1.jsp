...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/productsale1!getList_pass.do?enterpriseID=${productsale.idss}',
		dataType: 'json',
		colModel: [
	...
	function toolbarItem_onclick(cmd, grid) {
		if (cmd == "add") {
			window.location.href = "${ctx}/admin/productsale!add.do";
		} else if (cmd == "modify") {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/productsale1!loadocc.do?ouc="+ouc;
			} else {
