...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/nongshi!saveAdd.do">
    ...
    <tr >
        ...
        <tr>
            <th>日期：</th>
            <td>
            <input value="${shengChanBase}" name="baseID" hidden />
        ...
        <tr>
            <th>农业投入品：</th>
            <td>
            <input type="text" name="touruPin" id="touruPin" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>天气状况：</th>
            <td>
            <input type="text" name="tianQi" id="tianQi" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>备注：</th>
            <td>
            <input type="text" name="simpleContent" id="simpleContent" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
