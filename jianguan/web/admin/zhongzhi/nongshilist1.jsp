...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/nongshi1!getList_pass.do?enterpriseID=${nongshi.idss}',
		dataType: 'json',
		colModel: [
			{display: '序号',name: 'id', width: 50, align: 'center',iskey:true},
			{display: '日期',name: 'id', width: 120, align: 'center'},
			{display: '田块编号',name: 'id', width: 70, align: 'center'},
	...
	function toolbarItem_onclick(cmd, grid) {
		if (cmd == "add") {
			window.location.href = "${ctx}/admin/nongshi!add.do";
		} else if (cmd == "modify") {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/nongshi1!loadocc.do?ouc="+ouc;
			} else {
