...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/zhiliang!saveAdd.do">
    ...
    <tr >
        ...
        <tr>
            <th>日期：</th>
            <td>
            <input value="${shengChanBase}" name="baseID" />
        ...
        <tr>
            <th>检测方法：</th>
            <td>
            <input type="text" name="jianCeMethod" id="jianCeMethod" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>检测结果：</th>
            <td>
            <input type="text" name="jianCeJGuo" id="jianCeJGuo" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>检测单位及人员：</th>
            <td>
            <input type="text" name="jianCeName" id="jianCeName" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
