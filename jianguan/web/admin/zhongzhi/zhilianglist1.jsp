...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/zhiliang1!getList_pass.do?enterpriseID=${zhiliang.idss}',
		dataType: 'json',
		colModel: [
	...
	function toolbarItem_onclick(cmd, grid) {
		if (cmd == "add") {
			window.location.href = "${ctx}/admin/zhiliang!add.do";
		} else if (cmd == "modify") {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/zhiliang1!loadocc.do?ouc="+ouc;
			} else {
