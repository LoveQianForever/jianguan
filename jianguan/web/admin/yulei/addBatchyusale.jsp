...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <div class="option">
	<ul class="clearfix">
	<li id="one1" class="hover"><span><img src="${ctx}/image/icon/icon01.gif" />鱼产销售</span></li>
	</ul>
</div>
<div style="display: block; padding: 10px;" id="con_one_2">
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/yusale!saveAdd.do">
    ...
    <tbody>
       <tr >
        ...
        <tr>
            <th>销售去向：</th>
            <td>
            <input type="text" name="fromPlace" id="fromPlace" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
