...
<div class="boxBack">
    ...
    <tr><td>温馨提示：</td>
       ...
       <tr>
            <th>溯源批次：</th>
            <td>
            ${inpigfoodmedicinerecord.piCi}
            </td>  
        </tr>
        <tr>
            <th>日期：</th>
            <td>
           ${inpigfoodmedicinerecord.createTime}
            </td>
        </tr>
        <tr>
            <th>品名：</th>
            <td>
            ${inpigfoodmedicinerecord.inPigFoodMedicine.name}
            </td>
        </tr>
        <tr>
            <th>数量：</th>
            <td>
           ${inpigfoodmedicinerecord.count}
            </td>
        </tr>
        <tr>
            <th>采购人：</th>
            <td>
            ${inpigfoodmedicinerecord.buy_name}
            </td>
        </tr>
