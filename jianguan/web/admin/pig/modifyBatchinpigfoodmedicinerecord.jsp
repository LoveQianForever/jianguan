    ...
    <tbody>
       <tr>
           ...
           <select id="batchID" name="batchID" class="input"  onfocus="this.className='inputClick'" class="inputText" style="width:520px;">
		        			 <option value="${inpigfoodmedicinerecord.piCi}">第${inpigfoodmedicinerecord.piCi}批</option>
        ...
        <tr>
           ...
           <input type="text" name="createTime" value='<fmt:formatDate value="${inpigfoodmedicinerecord.createTime}"/>' id="createTime" class="input Wdate"  style="width: 520px" 
