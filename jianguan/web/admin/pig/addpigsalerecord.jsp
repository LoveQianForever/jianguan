...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/pigsalerecord!saveAdd.do">
    ...
    <tbody>
        <tr>
            ...
            <input type="text" name="saleDate" id="saleDate" class="input Wdate"  style="width: 520px" 
        ...
        <tr>
            <th>猪只类别：</th>
            <td>
            <input type="text" name="leiBie" id="leiBie" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>耳    标：</th>
            <td>
            <input type="text" name="erBiao" id="erBiao" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>销售单价：</th>
            <td>
            <input type="text" name="singlePrice" id="singlePrice" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>销售总重量：</th>
            <td>
            <input type="text" name="weight" id="weight" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
