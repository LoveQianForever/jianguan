...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/inpigfoodmedicinerecord!saveAdd.do">
    ...
    <tbody>
        ...
        <tr>
            <th>采购人：</th>
            <td>
            <input type="text" name="buy_name" id="buy_name" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
