...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <div class="option">
	<ul class="clearfix">
	<li id="one1" class="hover"><span><img src="${ctx}/image/icon/icon01.gif" />母猪配种</span></li>
	</ul>
</div>
...
<div class="boxBack">
    ...
    <tbody>
        ...
        <tr>
            <th>(副)配对时间：</th>
            <td>
             <input type="text" name="peiDuiTime11" id="peiDuiTime11" class="input Wdate"  style="width: 520px" 
            	onFocus="WdatePicker({peiDuiTime:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})"/>
        ...
        <tr>
            <th>(副)品种（公）：</th>
            <td>
            <input type="text" name="pinZhongG11" id="pinZhongG11" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
            <span id="pinZhongGTip"></span>
            </td>
        </tr>
        <tr>
            <th>(副)耳号（公）：</th>
            <td>
            <input type="text" name="erHaoG11" id="erHaoG11" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
            <span id="erHaoGTip"></span>
            </td>
        </tr>
        ...
        <tr>
            <th>(副)配种方式：</th>
            <td>
            <input type="text" name="peiZhongFangShi11" id="peiZhongFangShi11" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
            <span id="peiZhongFangShiTip"></span>
            </td>
        </tr>
        <tr>
            <th>(副)配种执行人：</th>
            <td>
            <input type="text" name="peiZhong_name11" id="peiZhong_name11" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
            <span id="peiZhong_nameTip"></span>
            </td>
        </tr>
        <!-- 
