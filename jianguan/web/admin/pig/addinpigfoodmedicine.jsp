...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/inpigfoodmedicine!saveAdd.do">
    ...
    <tbody>
        ...
        <tr>
            <th>批文批号：</th>
            <td>
            <input type="text" name="piWenPiHao" id="piWenPiHao" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
