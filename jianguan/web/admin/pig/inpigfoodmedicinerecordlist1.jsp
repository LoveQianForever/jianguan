...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/inpigfoodmedicinerecord1!getList_pass.do?enterpriseID=${inpigfoodmedicinerecord.idss}',
		dataType: 'json',
		colModel: [
			...
			{display: '采购人',name: 'id', width: 100, align: 'center'},	
	...
	function toolbarItem_onclick(cmd, grid) {
		if (cmd == "add") {
			window.location.href = "${ctx}/admin/inpigfoodmedicinerecord!add.do";
		} else if (cmd == "modify") {
			if($('.trSelected', grid).length==1){
				...
				window.location.href = "${ctx}/admin/inpigfoodmedicinerecord!modify.do?ouc="+id;
			} else {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/inpigfoodmedicinerecord1!loadocc.do?ouc="+ouc;
			} else {
