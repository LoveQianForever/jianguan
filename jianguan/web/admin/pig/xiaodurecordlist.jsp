...
$(document).ready(function() {
	...
	$("#tab1").flexigrid({
		url: '${ctx}/admin/xiaodurecord!getList_pass.do',
		dataType: 'json',
		colModel: [
	...
	function toolbarItem_onclick(cmd, grid) {
		if (cmd == "add") {
			...
			if($('.trSelected', grid).length==1){
				...
				window.location.href = "${ctx}/admin/xiaodurecord!modify.do?ouc="+id;
			} else {
		...
		//文档下载 功能
			...
			if($('.trSelected', grid).length>0){
				...
				window.location.href = "${ctx}/admin/xiaodurecord!loadocc.do?ouc="+ouc;
			} else {
