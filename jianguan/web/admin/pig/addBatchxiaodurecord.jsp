...
<div class="boxBack">
    <form method="post" id="form1" action="${ctx}/admin/xiaodurecord!saveAdd.do">
    ...
    <tbody>
       <tr >
        ...
        <tr>
            <th>消毒对象：</th>
            <td>
            <input type="text" name="proObject" id="proObject" onfocus="this.className='inputClick'"   class="input" class="inputText" style="width:520px;" />
        ...
        <tr>
            <th>消毒方法：</th>
            <td>
            <input type="text" name="xiaoDuFa" id="xiaoDuFa" onfocus="this.className='inputClick'"  class="input" class="inputText" style="width:520px;" />
